...
scripts/install.sh:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/HQ/test_project/SigmoidCustom/SigmoidCustom/build_out/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating scripts/install.sh, scripts/upgrade.sh"
	mkdir -p /opt/HQ/test_project/SigmoidCustom/SigmoidCustom/build_out/scripts
	cp -r /opt/HQ/test_project/SigmoidCustom/SigmoidCustom/scripts/* /opt/HQ/test_project/SigmoidCustom/SigmoidCustom/build_out/scripts/
	sed -i s/vendor_name=customize/vendor_name=customize/g /opt/HQ/test_project/SigmoidCustom/SigmoidCustom/build_out/scripts/*
