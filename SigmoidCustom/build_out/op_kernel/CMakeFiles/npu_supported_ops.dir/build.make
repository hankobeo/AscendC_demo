...
op_kernel/tbe/op_info_cfg/ai_core/npu_supported_ops.json:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/HQ/test_project/SigmoidCustom/SigmoidCustom/build_out/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating tbe/op_info_cfg/ai_core/npu_supported_ops.json"
	cd /opt/HQ/test_project/SigmoidCustom/SigmoidCustom/build_out/op_kernel && mkdir -p /opt/HQ/test_project/SigmoidCustom/SigmoidCustom/build_out/op_kernel/tbe/op_info_cfg/ai_core
	cd /opt/HQ/test_project/SigmoidCustom/SigmoidCustom/build_out/op_kernel && ../../cmake/util/gen_ops_filter.sh /opt/HQ/test_project/SigmoidCustom/SigmoidCustom/build_out/autogen /opt/HQ/test_project/SigmoidCustom/SigmoidCustom/build_out/op_kernel/tbe/op_info_cfg/ai_core
...
op_kernel/CMakeFiles/npu_supported_ops.dir/clean:
	cd /opt/HQ/test_project/SigmoidCustom/SigmoidCustom/build_out/op_kernel && $(CMAKE_COMMAND) -P CMakeFiles/npu_supported_ops.dir/cmake_clean.cmake
